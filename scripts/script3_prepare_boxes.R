...
##############################     SETUP YOUR DATA 
#######################################################################
setwd("/media/dannunzio/OSDisk/Users/dannunzio/Documents/countries/cambodia/workshop_20170911/")

## Read the datafile and setup the correct names for the variables
pts <- read.csv("pts_khm_all_country.csv")
...
writeOGR(obj=sqr_df_selected,dsn=paste("gee_kml_files/",base_sqr,".shp",sep=""),layer=base_sqr,driver = "ESRI Shapefile",overwrite_layer = T)
